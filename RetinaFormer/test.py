...
parser.add_argument('--data_dir', default='/home/ubuntu/data/ITS/', type=str, help='path to dataset')
parser.add_argument('--save_dir', default='/home/ubuntu/zhangyun/code/onoffformer-0704/saved_models/', type=str, help='path to models saving')
...
if __name__ == '__main__':
	...
	"""
	#args.data_dir= "/home/ubuntu/zhangyun/code/onoffFormer/data/ITS"
	test_dataset = PairLoader(args.data_dir, 'test', 'test')
