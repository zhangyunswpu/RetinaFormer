...
parser.add_argument('--data_dir', default='/home/ubuntu/data/ITS/', type=str, help='path to dataset')  # 数据集路径
...
if __name__ == '__main__':
    ...
    train_dataset = PairLoader(args.data_dir, 'train', 'train',
    ...
    train_loader = DataLoader(train_dataset,
                              ...
                              pin_memory=True,
                              drop_last=True)
    val_dataset = PairLoader(args.data_dir, 'test', 'test',
                             setting['patch_size'])
